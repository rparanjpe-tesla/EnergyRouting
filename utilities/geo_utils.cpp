...
{
    double delta_lambda = fabs(GeoUtils::toRadians(n0.lon - n1.lon));
    double delta_phi    = fabs(GeoUtils::toRadians(n0.lat - n1.lat));
    double cos_phi1     = cos(GeoUtils::toRadians(n0.lat));
    double cos_phi2     = cos(GeoUtils::toRadians(n1.lat));
